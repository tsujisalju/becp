...
export const SKILL_LEVELS = {
  beginner: { min: 0, max: 99, label: 'Beginner', color: "#a7f3d0" },
  intermediate: { min: 100, max: 299, label: 'Intermediate', color: "#bfdbfe" },
  advanced: { min: 300, max: 699, label: 'Advanced', color: "#e9d5ff"},
  expert: { min: 700, max: Infinity, label: 'Expert', color: "#fde68a" },
} as const
