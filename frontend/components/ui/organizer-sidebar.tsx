...
// Program Name     : frontend/components/ui/organizer-sidebar.tsx
// Description      : Sidebar component for organizer portal. Provide navigation and wallet connection status.
...
const items = [
  {
    title: "Overview",
    url: ROUTES.ORGANIZER_PORTAL,
    icon: <SquareChartGantt />,
  },
  {
    title: "My Events",
    url: ROUTES.ORGANIZER_EVENTS,
    icon: <CalendarFold />,
  },
  {
